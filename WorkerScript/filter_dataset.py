...
if __name__ == '__main__':
    import sys
    dataset_dir  = sys.argv[1] if len(sys.argv) > 1 else f'{SEROOT}/data/processed/unfiltered'
    filtered_dir = sys.argv[2] if len(sys.argv) > 2 else f'{SEROOT}/data/processed/filtered'
    filter_all(dataset_dir, filtered_dir)